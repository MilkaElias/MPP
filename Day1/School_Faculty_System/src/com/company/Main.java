...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Person johnGore = new StaffStudent("John","472-3321",33,4.0,5600);
        Person adamThomas = new StaffStudent("Adam Thomas","472-7552",21,3.5,3500);
        Person andrewHeck = new StaffStudent("Andresw Heck","472-8890",29,2.8,6000);
        dept.addPerson(johnGore);
        dept.addPerson(adamThomas);
        dept.addPerson(andrewHeck);
        ...
        Course cs450 = new Course("cs450","Advanced architecture",5,johnDoodle);
